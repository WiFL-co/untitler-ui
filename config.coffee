...
# See docs at http://brunch.readthedocs.org/en/latest/config.html.
  conventions:
    assets: /^app\/assets\//
    vendor: -> true #hack to force brunch-coffeescript to wrap anonymous functions http://stackoverflow.com/questions/11074297/brunch-how-to-disable-requirejs-module-wrapping
  modules:
    definition: false
    wrapper: false
  paths:
